...
\begin{parts}
    \part[3] Using \verb+reduce+, write a one-line function to concatenate a nested list of depth 1 into a single list. (Example nested list of depth 1: $[[1,2],[3,4],[5,6]]$)
