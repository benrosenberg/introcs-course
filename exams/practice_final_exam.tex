...
\begin{parts}
    ...
    \part[3] Describe the way that \verb+reduce+ works. What kind of function does it take as a parameter?
...
\begin{parts}
    \part[3] Using \verb+reduce+, write a one-line function to concatenate a nested list of depth 1 into a single list.
